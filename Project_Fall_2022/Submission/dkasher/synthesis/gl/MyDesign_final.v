...
module MyDesign ( dut_run, dut_busy, reset_b, clk, input_sram_write_enable, 
  ...
  wire   counter, N639, N640, N641, N642, N643, N644, N645, N646, N647, N648,
         ...
         n624, n625, n626, n627, n628, DP_OP_150_131_9494_n439, n630, n631,
  ...
  DFF_X1 Read_Size_reg_0_ ( .D(n616), .CK(clk), .Q(Read_Size[0]), .QN(n2322)
         );
  DFF_X1 Read_Size_reg_1_ ( .D(n615), .CK(clk), .Q(Read_Size[1]), .QN(n2320)
         );
  DFF_X1 Read_Size_reg_2_ ( .D(n614), .CK(clk), .Q(Read_Size[2]), .QN(n2317)
         );
  DFF_X1 Read_Size_reg_3_ ( .D(n613), .CK(clk), .Q(Read_Size[3]), .QN(n2315)
         );
  DFF_X1 Read_Size_reg_4_ ( .D(n612), .CK(clk), .Q(Read_Size[4]), .QN(n2319)
         );
  DFF_X1 Read_Size_reg_5_ ( .D(n611), .CK(clk), .Q(Read_Size[5]), .QN(n2321)
         );
  DFF_X1 Read_Size_reg_6_ ( .D(n610), .CK(clk), .Q(Read_Size[6]), .QN(n2316)
         );
  DFF_X1 Read_Size_reg_7_ ( .D(n609), .CK(clk), .Q(Read_Size[7]), .QN(n2318)
         );
  DFF_X1 N_reg_7_ ( .D(N658), .CK(clk), .Q(N[7]), .QN(n2273) );
  DFF_X1 N_reg_6_ ( .D(N657), .CK(clk), .Q(N[6]), .QN(n2271) );
  DFF_X1 N_reg_5_ ( .D(N656), .CK(clk), .Q(N[5]), .QN(n2268) );
  DFF_X1 N_reg_4_ ( .D(N655), .CK(clk), .Q(N[4]), .QN(n2270) );
  DFF_X1 N_reg_3_ ( .D(N654), .CK(clk), .Q(N[3]), .QN(n2261) );
  DFF_X1 N_reg_2_ ( .D(N653), .CK(clk), .Q(N[2]), .QN(n2235) );
  DFF_X1 N_reg_1_ ( .D(N652), .CK(clk), .Q(N[1]), .QN(n2234) );
  DFF_X1 N_reg_0_ ( .D(N651), .CK(clk), .Q(N[0]), .QN(n2242) );
  DFF_X1 Read_data_reg_7_ ( .D(n578), .CK(clk), .Q(Read_data[7]), .QN(n649) );
  DFF_X1 Read_data_reg_6_ ( .D(n577), .CK(clk), .Q(Read_data[6]), .QN(n2332)
         );
  DFF_X1 Read_data_reg_4_ ( .D(n575), .CK(clk), .Q(Read_data[4]) );
  DFF_X1 Read_data_ker_reg_6_ ( .D(n569), .CK(clk), .Q(Read_data_ker[6]) );
  DFF_X1 Read_data_ker_reg_5_ ( .D(n568), .CK(clk), .Q(Read_data_ker[5]) );
  DFF_X1 Read_data_ker_reg_3_ ( .D(n566), .CK(clk), .Q(Read_data_ker[3]), .QN(
        n662) );
  DFF_X1 Read_data_ker_reg_0_ ( .D(n563), .CK(clk), .Q(Read_data_ker[0]), .QN(
        n873) );
  DFF_X1 Accumulator_reg_15_ ( .D(n543), .CK(clk), .Q(Accumulator[15]), .QN(
        n2306) );
  DFF_X1 Accumulator_reg_13_ ( .D(n541), .CK(clk), .Q(Accumulator[13]), .QN(
        n2309) );
  DFF_X1 Accumulator_reg_12_ ( .D(n540), .CK(clk), .Q(Accumulator[12]), .QN(
        n2326) );
  DFF_X1 Accumulator_reg_11_ ( .D(n539), .CK(clk), .Q(Accumulator[11]), .QN(
        n2310) );
  DFF_X1 Accumulator_reg_10_ ( .D(n538), .CK(clk), .Q(Accumulator[10]), .QN(
        n2307) );
  DFF_X1 Accumulator_reg_9_ ( .D(n537), .CK(clk), .Q(Accumulator[9]), .QN(
        n2280) );
  DFF_X1 Accumulator_reg_8_ ( .D(n536), .CK(clk), .Q(Accumulator[8]), .QN(
        n2249) );
  DFF_X1 Accumulator_reg_7_ ( .D(n535), .CK(clk), .Q(Accumulator[7]), .QN(
        n2279) );
  DFF_X1 Accumulator_reg_6_ ( .D(n534), .CK(clk), .Q(Accumulator[6]), .QN(
        n2246) );
  DFF_X1 Accumulator_reg_5_ ( .D(n533), .CK(clk), .Q(Accumulator[5]), .QN(
        n2327) );
  DFF_X1 Accumulator_reg_4_ ( .D(n532), .CK(clk), .Q(Accumulator[4]), .QN(
        n2308) );
  DFF_X1 Accumulator_reg_3_ ( .D(n531), .CK(clk), .Q(Accumulator[3]), .QN(
        n2311) );
  DFF_X1 Accumulator_reg_2_ ( .D(n530), .CK(clk), .Q(Accumulator[2]), .QN(
        n2243) );
  DFF_X1 Accumulator_reg_1_ ( .D(n529), .CK(clk), .Q(Accumulator[1]), .QN(
        n2328) );
  DFF_X1 Accumulator_reg_0_ ( .D(n528), .CK(clk), .Q(Accumulator[0]), .QN(
        n2323) );
  DFF_X1 Storage_2_reg_14_ ( .D(n594), .CK(clk), .Q(Storage_2[14]), .QN(n2218)
         );
  DFF_X1 Storage_1_reg_14_ ( .D(n593), .CK(clk), .Q(Storage_1[14]), .QN(n2275)
         );
  DFF_X1 Storage_2_reg_13_ ( .D(n595), .CK(clk), .Q(Storage_2[13]), .QN(n2245)
         );
  DFF_X1 Storage_1_reg_13_ ( .D(n592), .CK(clk), .Q(Storage_1[13]), .QN(n2226)
         );
  DFF_X1 Storage_2_reg_12_ ( .D(n596), .CK(clk), .Q(Storage_2[12]), .QN(n2251)
         );
  DFF_X1 Storage_1_reg_12_ ( .D(n591), .CK(clk), .QN(n2274) );
  DFF_X1 Storage_2_reg_11_ ( .D(n597), .CK(clk), .Q(Storage_2[11]), .QN(n2225)
         );
  DFF_X1 Storage_1_reg_11_ ( .D(n590), .CK(clk), .Q(Storage_1[11]), .QN(n2244)
         );
  DFF_X1 Storage_2_reg_10_ ( .D(n598), .CK(clk), .QN(n2217) );
  DFF_X1 Storage_1_reg_10_ ( .D(n589), .CK(clk), .Q(Storage_1[10]), .QN(n2248)
         );
  DFF_X1 Storage_2_reg_9_ ( .D(n599), .CK(clk), .Q(Storage_2[9]), .QN(n2224)
         );
  DFF_X1 Storage_1_reg_9_ ( .D(n588), .CK(clk), .Q(Storage_1[9]), .QN(n2241)
         );
  DFF_X1 Storage_2_reg_8_ ( .D(n600), .CK(clk), .QN(n2216) );
  DFF_X1 Storage_1_reg_8_ ( .D(n587), .CK(clk), .Q(Storage_1[8]), .QN(n2314)
         );
  DFF_X1 Storage_2_reg_7_ ( .D(n601), .CK(clk), .Q(Storage_2[7]), .QN(n2239)
         );
  DFF_X1 Storage_1_reg_7_ ( .D(n586), .CK(clk), .Q(Storage_1[7]), .QN(n2215)
         );
  DFF_X1 Storage_2_reg_6_ ( .D(n602), .CK(clk), .Q(Storage_2[6]), .QN(n2312)
         );
  DFF_X1 Storage_1_reg_6_ ( .D(n585), .CK(clk), .Q(Storage_1[6]), .QN(n2233)
         );
  DFF_X1 Storage_2_reg_5_ ( .D(n603), .CK(clk), .Q(Storage_2[5]), .QN(n2231)
         );
  DFF_X1 Storage_1_reg_5_ ( .D(n584), .CK(clk), .Q(Storage_1[5]), .QN(n2263)
         );
  DFF_X1 Storage_2_reg_4_ ( .D(n604), .CK(clk), .QN(n2223) );
  DFF_X1 Storage_1_reg_4_ ( .D(n583), .CK(clk), .Q(Storage_1[4]), .QN(n2247)
         );
  DFF_X1 Storage_2_reg_3_ ( .D(n605), .CK(clk), .Q(Storage_2[3]), .QN(n2232)
         );
  DFF_X1 Storage_1_reg_3_ ( .D(n582), .CK(clk), .Q(Storage_1[3]), .QN(n2221)
         );
  DFF_X1 Storage_2_reg_2_ ( .D(n606), .CK(clk), .Q(Storage_2[2]), .QN(n2313)
         );
  DFF_X1 Storage_1_reg_2_ ( .D(n581), .CK(clk), .Q(Storage_1[2]), .QN(n2257)
         );
  DFF_X1 Storage_2_reg_1_ ( .D(n607), .CK(clk), .Q(Storage_2[1]), .QN(n2250)
         );
  DFF_X1 Storage_1_reg_1_ ( .D(n580), .CK(clk), .Q(Storage_1[1]), .QN(n2230)
         );
  DFF_X1 Storage_2_reg_0_ ( .D(n608), .CK(clk), .Q(Storage_2[0]), .QN(n2252)
         );
  DFF_X1 Storage_1_reg_0_ ( .D(n579), .CK(clk), .Q(Storage_1[0]), .QN(n2259)
         );
  DFF_X1 counter_x_reg_7_ ( .D(n617), .CK(clk), .Q(counter_x[7]), .QN(n2269)
         );
  DFF_X1 counter_x_reg_6_ ( .D(n618), .CK(clk), .Q(counter_x[6]), .QN(n2267)
         );
  DFF_X1 counter_x_reg_5_ ( .D(n619), .CK(clk), .Q(counter_x[5]), .QN(n2228)
         );
  DFF_X1 counter_x_reg_4_ ( .D(n620), .CK(clk), .Q(counter_x[4]), .QN(n2220)
         );
  DFF_X1 counter_x_reg_3_ ( .D(n621), .CK(clk), .Q(counter_x[3]), .QN(n2240)
         );
  DFF_X1 counter_x_reg_2_ ( .D(n622), .CK(clk), .Q(counter_x[2]), .QN(n2219)
         );
  DFF_X1 counter_x_reg_1_ ( .D(n623), .CK(clk), .Q(counter_x[1]), .QN(n2214)
         );
  DFF_X1 counter_x_reg_0_ ( .D(n624), .CK(clk), .Q(counter_x[0]), .QN(n2213)
         );
  DFF_X1 counter_y_reg_5_ ( .D(n519), .CK(clk), .Q(counter_y[5]), .QN(n2227)
         );
  DFF_X1 counter_y_reg_4_ ( .D(n518), .CK(clk), .Q(counter_y[4]), .QN(n2258)
         );
  DFF_X1 counter_y_reg_3_ ( .D(n517), .CK(clk), .Q(counter_y[3]), .QN(n2304)
         );
  DFF_X1 counter_y_reg_2_ ( .D(n516), .CK(clk), .Q(counter_y[2]), .QN(n2256)
         );
  DFF_X1 counter_y_reg_1_ ( .D(n515), .CK(clk), .Q(counter_y[1]), .QN(n2253)
         );
  DFF_X1 counter_y_reg_0_ ( .D(n522), .CK(clk), .Q(counter_y[0]), .QN(n2286)
         );
  DFF_X1 counter_reg ( .D(n548), .CK(clk), .Q(counter), .QN(n2272) );
  DFFR_X1 current_state_reg_2_ ( .D(n549), .CK(clk), .RN(n672), .Q(
        current_state[2]), .QN(n2266) );
  DFFR_X1 current_state_reg_0_ ( .D(n625), .CK(clk), .RN(n672), .Q(
        current_state[0]), .QN(n2229) );
  DFFR_X1 current_state_reg_1_ ( .D(n626), .CK(clk), .RN(reset_b), .Q(
        current_state[1]), .QN(n2260) );
  DFFR_X1 current_state_reg_5_ ( .D(n550), .CK(clk), .RN(n672), .Q(
        current_state[5]), .QN(n2254) );
  DFFR_X1 current_state_reg_3_ ( .D(n628), .CK(clk), .RN(reset_b), .Q(
        current_state[3]), .QN(n2222) );
  DFFR_X1 current_state_reg_4_ ( .D(n627), .CK(clk), .RN(reset_b), .Q(
        current_state[4]), .QN(n2255) );
  DFF_X1 Read_data_reg_0_ ( .D(n2334), .CK(clk), .Q(n669), .QN(n650) );
  DFFS_X2 Read_data_reg_1_ ( .D(n2333), .CK(clk), .SN(1'b1), .Q(n876), .QN(
        Read_data[1]) );
  DFFS_X1 Read_data_ker_reg_1_ ( .D(n2335), .CK(clk), .SN(1'b1), .Q(n665), 
        .QN(Read_data_ker[1]) );
  DFFS_X2 input_sram_read_address_reg_8_ ( .D(N647), .CK(clk), .SN(1'b1), .Q(
        input_sram_read_address[8]), .QN(DP_OP_150_131_9494_n439) );
  DFF_X2 input_sram_read_address_reg_6_ ( .D(N645), .CK(clk), .Q(
        input_sram_read_address[6]), .QN(n2277) );
  DFF_X2 input_sram_read_address_reg_2_ ( .D(N641), .CK(clk), .Q(
        input_sram_read_address[2]), .QN(n2284) );
  DFF_X2 input_sram_read_address_reg_0_ ( .D(N639), .CK(clk), .Q(
        input_sram_read_address[0]), .QN(n2288) );
  DFF_X2 input_sram_read_address_reg_10_ ( .D(N649), .CK(clk), .Q(
        input_sram_read_address[10]), .QN(n875) );
  DFF_X2 input_sram_read_address_reg_5_ ( .D(N644), .CK(clk), .Q(
        input_sram_read_address[5]), .QN(n2283) );
  DFF_X2 input_sram_read_address_reg_11_ ( .D(N650), .CK(clk), .Q(
        input_sram_read_address[11]) );
  DFF_X2 output_sram_write_addresss_reg_6_ ( .D(n491), .CK(clk), .Q(
        output_sram_write_addresss[6]), .QN(n2303) );
  DFF_X2 output_sram_write_addresss_reg_1_ ( .D(n496), .CK(clk), .Q(
        output_sram_write_addresss[1]), .QN(n2238) );
  DFF_X2 output_sram_write_addresss_reg_9_ ( .D(n488), .CK(clk), .Q(
        output_sram_write_addresss[9]), .QN(n2237) );
  DFF_X2 weights_sram_read_address_reg_2_ ( .D(n560), .CK(clk), .Q(
        weights_sram_read_address[2]), .QN(n2305) );
  DFF_X2 weights_sram_read_address_reg_5_ ( .D(n557), .CK(clk), .Q(
        weights_sram_read_address[5]), .QN(n2290) );
  DFF_X2 weights_sram_read_address_reg_7_ ( .D(n555), .CK(clk), .Q(
        weights_sram_read_address[7]), .QN(n2291) );
  DFF_X2 weights_sram_read_address_reg_3_ ( .D(n559), .CK(clk), .Q(
        weights_sram_read_address[3]), .QN(n2292) );
  DFF_X2 output_sram_write_addresss_reg_0_ ( .D(n497), .CK(clk), .Q(
        output_sram_write_addresss[0]), .QN(n2265) );
  DFF_X2 weights_sram_read_address_reg_10_ ( .D(n552), .CK(clk), .Q(
        weights_sram_read_address[10]), .QN(n2293) );
  DFF_X2 output_sram_write_addresss_reg_8_ ( .D(n489), .CK(clk), .Q(
        output_sram_write_addresss[8]), .QN(n2264) );
  DFF_X2 weights_sram_read_address_reg_9_ ( .D(n553), .CK(clk), .Q(
        weights_sram_read_address[9]), .QN(n2299) );
  DFF_X2 weights_sram_read_address_reg_6_ ( .D(n556), .CK(clk), .Q(
        weights_sram_read_address[6]), .QN(n2295) );
  DFF_X2 output_sram_write_data_reg_1_ ( .D(n507), .CK(clk), .Q(
        output_sram_write_data[1]) );
  DFF_X2 output_sram_write_data_reg_2_ ( .D(n508), .CK(clk), .Q(
        output_sram_write_data[2]) );
  DFF_X2 output_sram_write_data_reg_3_ ( .D(n509), .CK(clk), .Q(
        output_sram_write_data[3]) );
  DFF_X2 output_sram_write_data_reg_4_ ( .D(n510), .CK(clk), .Q(
        output_sram_write_data[4]) );
  DFF_X2 output_sram_write_data_reg_5_ ( .D(n511), .CK(clk), .Q(
        output_sram_write_data[5]) );
  DFF_X2 output_sram_write_data_reg_6_ ( .D(n512), .CK(clk), .Q(
        output_sram_write_data[6]) );
  DFF_X2 output_sram_write_data_reg_0_ ( .D(n514), .CK(clk), .Q(
        output_sram_write_data[0]) );
  DFF_X2 output_sram_write_data_reg_14_ ( .D(n500), .CK(clk), .Q(
        output_sram_write_data[14]) );
  DFF_X2 output_sram_write_data_reg_13_ ( .D(n501), .CK(clk), .Q(
        output_sram_write_data[13]) );
  DFF_X2 output_sram_write_data_reg_12_ ( .D(n502), .CK(clk), .Q(
        output_sram_write_data[12]) );
  DFF_X2 output_sram_write_data_reg_11_ ( .D(n503), .CK(clk), .Q(
        output_sram_write_data[11]) );
  DFF_X2 output_sram_write_data_reg_10_ ( .D(n504), .CK(clk), .Q(
        output_sram_write_data[10]) );
  DFF_X2 output_sram_write_data_reg_9_ ( .D(n505), .CK(clk), .Q(
        output_sram_write_data[9]) );
  DFF_X2 output_sram_write_data_reg_8_ ( .D(n506), .CK(clk), .Q(
        output_sram_write_data[8]) );
  DFF_X2 output_sram_write_addresss_reg_11_ ( .D(n498), .CK(clk), .Q(
        output_sram_write_addresss[11]), .QN(n2300) );
  DFF_X2 output_sram_write_enable_reg ( .D(n2336), .CK(clk), .Q(
        output_sram_write_enable) );
  DFF_X2 weights_sram_read_address_reg_11_ ( .D(n551), .CK(clk), .Q(
        weights_sram_read_address[11]), .QN(n2302) );
  DFF_X2 input_sram_read_address_reg_9_ ( .D(N648), .CK(clk), .Q(
        input_sram_read_address[9]) );
  DFF_X2 input_sram_read_address_reg_7_ ( .D(N646), .CK(clk), .Q(
        input_sram_read_address[7]), .QN(n2276) );
  DFF_X2 input_sram_read_address_reg_1_ ( .D(N640), .CK(clk), .Q(
        input_sram_read_address[1]), .QN(n2282) );
  DFF_X2 input_sram_read_address_reg_3_ ( .D(N642), .CK(clk), .Q(
        input_sram_read_address[3]), .QN(n2285) );
  DFF_X2 input_sram_read_address_reg_4_ ( .D(N643), .CK(clk), .Q(
        input_sram_read_address[4]), .QN(n2278) );
  DFF_X2 output_sram_write_addresss_reg_5_ ( .D(n492), .CK(clk), .Q(
        output_sram_write_addresss[5]), .QN(n2262) );
  DFF_X2 weights_sram_read_address_reg_1_ ( .D(n561), .CK(clk), .Q(
        weights_sram_read_address[1]), .QN(n2298) );
  DFF_X2 weights_sram_read_address_reg_0_ ( .D(n562), .CK(clk), .Q(
        weights_sram_read_address[0]), .QN(n2287) );
  DFF_X2 output_sram_write_addresss_reg_7_ ( .D(n490), .CK(clk), .Q(
        output_sram_write_addresss[7]), .QN(n2281) );
  DFF_X2 output_sram_write_addresss_reg_3_ ( .D(n494), .CK(clk), .Q(
        output_sram_write_addresss[3]), .QN(n2236) );
  DFF_X2 weights_sram_read_address_reg_8_ ( .D(n554), .CK(clk), .Q(
        weights_sram_read_address[8]), .QN(n2296) );
  DFF_X2 output_sram_write_addresss_reg_10_ ( .D(n487), .CK(clk), .Q(
        output_sram_write_addresss[10]), .QN(n2289) );
  DFF_X2 output_sram_write_addresss_reg_4_ ( .D(n493), .CK(clk), .Q(
        output_sram_write_addresss[4]), .QN(n2294) );
  DFF_X2 weights_sram_read_address_reg_4_ ( .D(n558), .CK(clk), .Q(
        weights_sram_read_address[4]), .QN(n2297) );
  DFF_X2 output_sram_write_addresss_reg_2_ ( .D(n495), .CK(clk), .Q(
        output_sram_write_addresss[2]), .QN(n2301) );
  DFF_X2 Read_data_reg_5_ ( .D(n576), .CK(clk), .Q(Read_data[5]), .QN(n2330)
         );
  DFF_X2 Accumulator_reg_14_ ( .D(n542), .CK(clk), .Q(Accumulator[14]), .QN(
        n2325) );
  DFF_X2 Read_data_reg_3_ ( .D(n574), .CK(clk), .Q(Read_data[3]), .QN(n2329)
         );
  DFF_X2 Read_data_reg_2_ ( .D(n573), .CK(clk), .Q(Read_data[2]), .QN(n2331)
         );
  DFF_X2 Read_data_ker_reg_4_ ( .D(n567), .CK(clk), .Q(Read_data_ker[4]) );
  DFF_X2 Read_data_ker_reg_7_ ( .D(n570), .CK(clk), .Q(Read_data_ker[7]) );
  DFF_X1 Read_data_ker_reg_2_ ( .D(n565), .CK(clk), .Q(Read_data_ker[2]) );
  DFFS_X2 counter_y_reg_6_ ( .D(n520), .CK(clk), .SN(1'b1), .Q(counter_y[6]), 
        .QN(n2324) );
  ...
  NAND2_X1 U1964 ( .A1(n2161), .A2(DP_OP_150_131_9494_n439), .ZN(n1724) );
